...
Public Class employeeEdit
    ...
    Private Sub binding()
        ...
        dv = New DataView(ds.Tables("employee_details"))
        ...
        emptelno.DataBindings.Clear()
        txtDob.DataBindings.Clear()
        empcat.DataBindings.Clear()
        ...
        emptelno.DataBindings.Add("Text", dv, "telno")
        txtDob.DataBindings.Add("Text", dv, "dateofbirth")
        empcat.DataBindings.Add("Text", dv, "category")
    ...
    Private Sub empphoto_Click(sender As Object, e As EventArgs) Handles empphoto.Click
    ...
    Private Sub Edit()
        Try
            ...
            cmd = New SqlCommand
            cmd.Connection = con
            cmd.CommandText = "update employee_details set firstname=@firstname, lastname=@lastname, address=@address, gender=@gender, telno=@telno, dateofbirth=@dateofbirth, category=@category,dateofjoin=@dateofjoin,department=@department,salary=@salary,photo=@photo where empno=@empno"
    ...
    Private Sub Delete()
        Try
            Dim a As String
            a = MessageBox.Show("Do you want to delete the record ?", "Payroll", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
            ...
            Else
                ...
                cmd = New SqlCommand
                cmd.Connection = con
                cmd.CommandText = "delete from employee_details where empno=@empno"
